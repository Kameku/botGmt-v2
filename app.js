...
//     .addAnswer('No entendemos tu solicitud')
//     .addAnswer('Prueba escribiendo la palabra *Asesor*')
//     .addAnswer(
//         [
//             "O recuerda nuestras opciones de consulta",
//             "👉🏻 1️⃣ 👈🏻. *Verificacion de pagos*",
...
const flowPrincipal = addKeyword(['hola','Hola ','hola ','Hola','buenos dias', 'buenos tardes', 'ole', 'alo'])
    .addAnswer('🙌 Hola! Bienvenido a GMT transportes logisticos')
    .addAnswer("Mi nombre es Stefani y te voy ayudar con tu solicitud",)
    .addAnswer(
        [
...
const main = async () => {
    ...
    const adapterFlow = createFlow([flowPrincipal, flowVerifyPay, flowCertificados, flowOther ])
